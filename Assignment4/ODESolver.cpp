...
void RK34_RC(double t, double deltaT, Vector2d last) {
    ...
    while (time < t) {
        ...
        if(time + deltaT > timerequirement) {
            ...
            K2 = copmute_xK_RC(last, K1, time2, temphalfDeltaT);
            K3 = copmute_xK_RC(last, K2, time3, temphalfDeltaT);
            K4 = copmute_xK_RC(last, K3, time4, tempDeltaT);
...
void RK34_EKV(double t, double deltaT, Vector2d last) {
    ...
    while (time < t) {
        ...
        if(time + deltaT > timerequirement) {
            ...
            K2 = copmute_xK(last, K1, time2, temphalfDeltaT);
            K3 = copmute_xK(last, K2, time3, temphalfDeltaT);
            K4 = copmute_xK(last, K3, time4, tempDeltaT);
